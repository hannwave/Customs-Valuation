...
public sealed class PlannedModulesController : ControllerBase
{
    ...
    [HttpGet("reference-prices"), Authorize(Policy = "OfficerOnly")]
    ...
    [HttpGet("reference-prices/{id:guid}"), Authorize(Policy = "OfficerOnly")]
    ...
    [HttpGet("hs-codes/{id:guid}/international-prices"), Authorize(Policy = "OfficerOnly")]
    ...
    [HttpGet("historical-customs-prices"), Authorize(Policy = "OfficerOnly")]
    ...
    [HttpGet("historical-customs-prices/{id:guid}"), Authorize(Policy = "OfficerOnly")]
    ...
    [HttpPost("price-sources"), Authorize(Policy = "SystemAdministrator")]
