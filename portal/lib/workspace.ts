...
export interface WorkspaceUser { id: string; username: string; email: string; fullName: string; role: WorkspaceRole; roleCode: string; active: boolean; status: string; primaryLocationId: string | null; regionKey: string; regionJoinedAt: string | null; archivedAt: string | null; archivedBy: string | null; archiveReason: string | null; version: string; employeeNumber: string; phone: string; createdAt?: string; updatedAt?: string | null; lastLoginAt?: string | null }
...
export interface AuditRecord { id: string; userId: string; subjectUserId: string | null; username: string; occurredAt: string; action: string; module: string; recordId: string; locationId: string | null; previousValueJson: string | null; newValueJson: string | null; decision: string | null; justification: string | null }
