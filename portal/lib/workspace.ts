...
export interface ValuationDecision { id: string; hsCodeId: string | null; selectedReferenceValue: number; currency: string; decision: string; justification: string; evidenceNotes: string; officerSubjectId: string; recordedAt: string; locationId: string | null; locationSnapshotJson: string; status: string; submittedAt: string | null; reviewedBy: string | null; reviewJustification: string | null; reviewedAt: string | null; version: string; declaredPriceAmount: number | null; declaredPriceCurrency: string; declaredPriceConvertedAmount: number | null; declaredPriceConvertedCurrency: string; declaredPriceExchangeRate: number | null; declaredPriceExchangeRateSource: string; declaredPriceExchangeRateDate: string | null; receiptFileName: string; receiptContentType: string; receiptFileSize: number | null; receiptSha256: string; receiptUploadedAt: string | null; receiptUploadedBy: string }
...
export interface AuditRecord { id: string; userId: string; username: string; occurredAt: string; action: string; module: string; recordId: string; locationId: string | null; previousValueJson: string | null; newValueJson: string | null; decision: string | null; justification: string | null; regionName?: string | null; branchName?: string | null; supervisorName?: string | null }
...
export interface DashboardDecision { id: string; hsCodeId: string | null; hsCode: string; product: string; selectedReferenceValue: number; currency: string; decision: string; status: string; recordedAt: string; locationId: string | null; declaredPriceAmount: number | null; declaredPriceCurrency: string; declaredPriceConvertedAmount: number | null; declaredPriceConvertedCurrency: string; receiptFileName: string }
