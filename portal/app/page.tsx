...
function SystemDashboard({ data, profile }: { data: WorkspaceDashboard; profile: WorkspaceProfile }) {
  return <>
    <DashboardHeader profile={profile} eyebrow="National control center" title="System overview" description="Organization, master data, integrations, and security across the Customs valuation platform." actions={<div className="dashboard-quick-actions"><Link href="/administration/regions"><FiMapPin />Add region</Link><Link href="/administration/branches"><FiMapPin />Add branch</Link><Link href="/administration"><FiUserPlus />Create administrator</Link><Link href="/audit"><FiActivity />Audit logs</Link></div>} />
    <KpiGrid data={data} />
    <div className="dashboard-main-grid">
      <section className="dashboard-panel dashboard-panel--wide"><div className="dashboard-panel-heading"><div><p className="eyebrow">Organization</p><h2>Customs structure</h2><span>Official hierarchy and operational status</span></div><Link href="/administration/regions">Manage <FiArrowRight /></Link></div><LocationTree locations={data.locations} /></section>
