...
function StatisticCard({ title, icon, stats, currency, tone }: { title: string; icon: React.ReactNode; stats: PriceStatistics | null; currency: string; tone: "international" | "local" }) {
  return <section className={`valuation-stat-card valuation-stat-card--${tone}`}>
