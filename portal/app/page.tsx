...
function AdminDashboard({ data, profile }: { data: WorkspaceDashboard; profile: WorkspaceProfile }) {
  return <>
    <DashboardHeader profile={profile} eyebrow="Customs Administrator · Overview" title="Overview" description="People, office assignments, and staff access requiring attention." actions={<div className="dashboard-quick-actions"><Link href="/administration"><FiUsers />Manage Officers</Link></div>} />
    <KpiGrid data={data} />
