...
export default function OutlierAnalysisPage() {
  ...
  return <Box className="data-page"><Container fluid p={0}><Stack gap="xl">
    ...
    <Group className="detail-link-row"><Link href="/dashboard">Back to Price Review <FiArrowRight /></Link><Link href="/historical-customs-prices">Open Customs History <FiArrowRight /></Link></Group>
